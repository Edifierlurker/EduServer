 ...
 */
public class AccountPrePay extends BaseServiceHandle {
    private static final String[] PARAMS = {"cpid","version","subject","hmac"};
    private static final String[] HMAC = {"useraccount","cporderid","appid","apppackagename","channelid","time","payfee","rtnurl"};
